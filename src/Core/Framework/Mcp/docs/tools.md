...
- **primary user** -- who the tool is mainly for in product terms (`merchant operator` or `developer integrator`)
- **home** -- whether the tool stays in **core** or moves to the optional merchant plugin from the ADR

For planning and issue naming, use **`SwagMcpMerchantAssistant`** as the working plugin name for the merchant-oriented tool bundle. Its tool namespace should be **`merchant-*`** so discovery clearly separates **core primitives** from **merchant assistant workflows**.

Primary-user labels are **documentation hints**, not authorization. Real enforcement comes from **ACL** and **per-integration MCP tool selection in Admin**.

## ADR-aligned tool matrix

The current PoC still exposes many of these tools from core. The matrix below shows the **target product split** from the ADR and the intended future name once a tool moves to the merchant plugin.

| Current tool | Primary user | Target home | Planned target name |
|---|---|---|---|
| `shopware-entity-schema` | developer integrator | core | unchanged |
| `shopware-entity-search` | developer integrator | core | unchanged |
| `shopware-entity-aggregate` | developer integrator | core | unchanged |
| `shopware-entity-read` | developer integrator | core | unchanged |
| `shopware-system-config-read` | developer integrator, merchant operator | core | unchanged |
| `shopware-entity-upsert` | developer integrator | core (evaluate carefully) | unchanged |
| `shopware-entity-delete` | developer integrator | core (evaluate carefully) | unchanged |
| `shopware-system-config-write` | developer integrator | core (evaluate carefully) | unchanged |
| `shopware-order-state` | merchant operator, developer integrator | core (evaluate carefully) | unchanged |
| `shopware-order-summary` | merchant operator | `SwagMcpMerchantAssistant` | `merchant-order-summary` |
| `shopware-customer-lookup` | merchant operator | `SwagMcpMerchantAssistant` | `merchant-customer-lookup` |
| `shopware-product-create` | merchant operator | `SwagMcpMerchantAssistant` | `merchant-product-create` |
| `shopware-revenue-report` | merchant operator | `SwagMcpMerchantAssistant` | `merchant-revenue-report` |
| `shopware-bestseller-report` | merchant operator | `SwagMcpMerchantAssistant` | `merchant-bestseller-report` |
| `shopware-storefront-search` | merchant operator | `SwagMcpMerchantAssistant` | `merchant-storefront-search` |
| `shopware-cart-manage` | merchant operator | `SwagMcpMerchantAssistant` | `merchant-cart-manage` |
| `shopware-cart-checkout` | merchant operator | `SwagMcpMerchantAssistant` | `merchant-cart-checkout` |
| `shopware-checkout-methods` | merchant operator | `SwagMcpMerchantAssistant` | `merchant-checkout-methods` |
| `shopware-media-upload` | merchant operator | `SwagMcpMerchantAssistant` | `merchant-media-upload` |
| `shopware-theme-config` | merchant operator | `SwagMcpMerchantAssistant` | `merchant-theme-config` |
...
**Planned home:** `SwagMcpMerchantAssistant` as `merchant-storefront-search`
...
All tools in this section are merchant-operator tools and are planned to move to **`SwagMcpMerchantAssistant`** with the `merchant-*` namespace.
...
**Primary user:** merchant operator
**Planned home:** `SwagMcpMerchantAssistant` as `merchant-media-upload`
...
**Primary user:** merchant operator
**Planned home:** `SwagMcpMerchantAssistant` as `merchant-theme-config`
